            ...
            try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
                ...
                var entity = MultipartEntityBuilder.create()
                    .addTextBody("prediction_config",
                        "{\"target_columns\":[{\"name\":\"category\",\"prediction_placeholder\":\"PLACEHOLDER\",\"task_type\":\"classification\",\"top_k\":1}],\"explanations\":{\"top_column_scores\":4,\"top_relevant_context_rows\":3}}",
